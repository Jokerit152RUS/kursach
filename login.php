...
<html>
	<head>
		...
		<meta name="description" content="Объявления. Популярные объявления. Дешево, автомобили, телефоны, техника, работа, квартиры, аренда, компьютеры, развлечения." />
...
<div id="logoAndMenu">
    ...
    <form action="/skelbimai/" id="searchForm">
...
<div id="register-form">
    <h2>Вход</h2>
    <form method="post" action="doLogin.php" style="display: inline-block; width: 300px; margin-bottom: 40px; margin-right: -1px;" id="registrationForm" autocomplete="off">
        <div class="group" id="user">
            <input type="text" name="login" value="" size="25" tabindex="2" maxlength="50" class="material-input" required autocomplete="off" id="login" />
        ...
        <div class="group">
            <input type="password" name="password" value="" size="25" tabindex="2" maxlength="30" class="material-input" required id="password" autocomplete="off"  />
            <span class="highlight"></span>
            <span class="bar"></span>
            <label>Пароль</label>
            <i></i>
        ...
        <div id="submitRegForm" class="mb-10">
            <!--<input type="text" name="gender" value="" class="display-none">
            <input type="password" name="password" id="repeat-password" class="display-none" autocomplete="off" disabled>
            <input type="hidden" name="step" value="1">-->
            <input type="submit" value="Вход" alt="Вход в учетную запись"  tabindex="6" id="login-button" />
        </div>
